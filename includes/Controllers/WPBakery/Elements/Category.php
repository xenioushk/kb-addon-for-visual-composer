		...
		$orderby_tags    = $this->get_orderby_tags();
			...
			$params = [
				...
				[
					...
					'type'        => 'kb_cat',
					'value'       => '',
					'heading'     => esc_html__( 'Categories', 'bkb_vc' ),
					'param_name'  => 'categories',
					'description' => esc_html__( 'Just drag and drop your required categories in to right box.', 'bkb_vc' ),
					'group'       => 'Categories',
				],
				...
				[
					...
					'value'       => '',
					'description' => esc_html__( 'Additional classes: bkbm-custom-layout-1, bkbm-box-shadow', 'bkb_vc' ),
					'group'       => 'Categories',
				],
				...
				[
					'type'        => 'dropdown',
					'class'       => '',
					'heading'     => esc_html__( 'Show Category Title?', 'bkb_vc' ),
				...
				[
					'type'        => 'dropdown',
					'class'       => '',
					'heading'     => esc_html__( 'Display Category Description?', 'bkb_vc' ),
					'param_name'  => 'bkb_desc',
					'value'       => $boolean_tags,
					'group'       => 'Settings',
					'description' => '',
				...
				[
					...
					'value'       => '',
					'description' => esc_html__( 'Additional classes: box-left-align, box-right-align, no-icon, no-separator, no-view-more-link', 'bkb_vc' ),
					'group'       => 'Settings',
					'dependency'  => [ 'element' => 'box_view', 'value' => [ '1' ] ],
				],
