 ...
 * Class ProgressBar
 *
 * Handles Petition ProgressBar WPBakery page builder element.
 *
 * @package BwlPetitionsManager
 */
class ProgressBar extends BaseController {
	...
	private function set_wpb_elem() {
		...
		$this->wpb_elem = [
			'name'                    => esc_html__( 'Petition Progress Bar', 'bwl_ptmn' ),
			'base'                    => 'petition_progress_bar',
			'category'                => 'Petition',
			'content_element'         => true,
			'show_settings_on_create' => true,
			'controls'                => 'full',
			'icon'                    => 'icon-bptm-vc-addon',
			'description'             => esc_html__( 'Display petition progress bar.', 'bwl_ptmn' ),
